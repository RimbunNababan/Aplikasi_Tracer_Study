  ...
  <body>
   <div class="header">
    <div class="logo">
      ...
      <img src="image/gambar/logo1.png" width="50" height="50"> <div class="unika"> <h2>Universitas Katolik<br>Santo Thomas Medan</h2> </div>
     </div>
       <div class="nav1">
        <a href="index.php">Home</a>
        <div class="link-wrapper">
          <a href="index.php">Tracer Study</a>
          <ul class="options">
            <li><a href="Hasil Tracer Study.php">Hasil Tracer Study</a></li> 
          </ul>
        </div>
        <a href="alumnijobboard.php">Alumni Job Board</a>
        <div class="link-wrapper">
          <a href="index.php">Dana Alumni Peduli </a>
          <ul class="options">
            <li><a href="laporandana.php">Laporan Dana </a></li>
          </div>
	    <a href="topgraduates.php">Top Graduates</a>
   ...
   <div class="search-container">
    <li><div class="search" style="margin-top: 10px;">      
      <form method="GET" action="pencarian laporan.php">
          <input type="text" name="cari" class="textbox" required placeholder="Cari " onfocus="this.value = '';" 
     ...
     <div>
        ...
        <table>
            <tr>
                <td>Laporan Dana Fikom Famz Event 2020</td>
                <td><img src="image/dana.jpg" alt="file" width="150" height="60"></td>
                <td><a href="https://drive.google.com/drive/my-drive?hl=id"><button id="download-btn">Download PDF</button></a></td>
            </tr>
            <tr>
                <td>Laporan Dana Natal Unika</td>
                <td><img src="image/dana.jpg" alt="file" width="150" height="60"></td>
                <td><a href="https://drive.google.com/drive/my-drive?hl=id"><button id="download-btn">Download PDF</button></a></td>
            </tr>
            <tr>
                <td>Laporan Dana Dies Natalies Unika ke-39</td>
                <td><img src="image/dana.jpg" alt="file" width="150" height="60"></td>
                <td><a href="https://drive.google.com/drive/my-drive?hl=id"><button id="download-btn">Download PDF</button></a></td>
            </tr>
        </table>
