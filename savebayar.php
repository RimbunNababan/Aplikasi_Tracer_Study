...
<div id="wrapper">
		<div class="container" style="background-color: silver">
            <div class="table-responsive">
	        	...
	        	<div class="hero-unit">
	        	<div class="unit"><h4>Silahkan Transfer kerekening ini 123-456-789 Bank BNI a/n UKST Medan</h4></div>
...
<form id="formku" action="checkout.php" method="POST" enctype="multipart/form-data">
	      ...
	      <a href="pembayaran.php" class="btn btn-sm btn-primary" style="background: #4CAF50;">Kembali</a>
