...
<div id="wrapper">
	<div class="container" style="background-color: silver; padding-top: 20px">
		...
		<div class="title"><h3>pembayaran Selesai</h3>
			<div class="hero-unit">Terima kasih Anda sudah menggalang dana dan berikut ini adalah data yang perlu anda catat.</div>
			<div class="hero-unit">
    <?php
			if($_POST['finish']){
				...
				$tanggal = date('Y-m-d');
				$sql  = mysqli_query($koneksi, "INSERT INTO pembayaran VALUES('', '$id_user', '$id_produk', '$jumlah', '$total','$alamat','$nohp', '$bukti', '$tanggal', 'Belum Dikirim')") or die(mysqli_error($koneksi));
				...
				if (!$sql) {
            		...
            		echo 'Total biaya untuk pembelian Produk adalah Rp. '.$total.',- <br>';
		...
		<center><a href="index.php" style="color: black;font-size: 12px"  class="btn btn-sm btn-primary"><b>Kembali ke Halaman Utama</b></a></center>
        </div>
